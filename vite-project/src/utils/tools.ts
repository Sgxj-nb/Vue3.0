 ...
 * @加密方式md5
 * */
export function hex_md5(s: any) { return binl2hex(core_md5(str2binl(s), s.length * chrsz)); }
export function b64_md5(s: any) { return binl2b64(core_md5(str2binl(s), s.length * chrsz)); }
export function str_md5(s: any) { return binl2str(core_md5(str2binl(s), s.length * chrsz)); }
export function hex_hmac_md5(key: any, data: any) { return binl2hex(core_hmac_md5(key, data)); }
export function b64_hmac_md5(key: any, data: any) { return binl2b64(core_hmac_md5(key, data)); }
export function str_hmac_md5(key: any, data: any) { return binl2str(core_hmac_md5(key, data)); }
